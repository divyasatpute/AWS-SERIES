...
👉 Recommended: **Use IAM + Bucket Policy**

---

## 🛠️ S3 Management Tools
...
- Eventual consistency (older behavior improved now)

---

## ♻️ Recover Deleted Objects
...
### Q1: What is S3?
Object storage service for storing data.

### Q2: What is a bucket?
Container for storing objects.

### Q3: What is versioning?
Stores multiple versions of object.

### Q4: Difference between EBS & S3?
- EBS → Block storage  
- S3 → Object storage  
...
👉 “S3 is not just storage — it’s the backbone of modern cloud data architecture.”
